...
####### Loading Dataset
X_train = np.array(np.load('./Data/X_PTB_Train.npz',allow_pickle=True)['arr_0'],dtype=np.float16)
y_train = np.load('./Data/y_PTB_Train.npz',allow_pickle=True)['arr_0']
...
history = model.fit((X_train,y_train_ohot),y_train_ohot,epochs=500,batch_size=512,
