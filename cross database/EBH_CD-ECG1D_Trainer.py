...
####### Loading Dataset
X_train = np.array(np.load('./Data/X_ECG1D_Train.npz',allow_pickle=True)['arr_0'],dtype=np.float16)
y_train = np.load('./Data/y_ECG1D_Train.npz',allow_pickle=True)['arr_0']
...
#### Model training
filepath = './models/EBH_CD-ECG1D.h5'
