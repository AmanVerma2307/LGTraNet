...
####### Loading Dataset
Train_Embeddings = np.load('./embeddings/EBH_CD_ecg1d-ptb_gallery.npz',allow_pickle=True)['arr_0']
Test_Embeddings = np.load('./embeddings/EBH_CD_ecg1d-ptb_probe.npz',allow_pickle=True)['arr_0']
...
##### Defining Essentials
match_text_genuine = open("./score files/EBH_CD_ecg1d-ptb_Genuine.txt",'w') # Matching Text File Creation for Genuine
match_text_imposter = open("./score files/EBH_CD_ecg1d-ptb_Imposter.txt",'w') # Matching Text File Creation for Imposter 
