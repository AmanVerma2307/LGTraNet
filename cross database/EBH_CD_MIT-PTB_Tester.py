...
model.load_weights('./models/EBH_CD-MIT.h5')
#model.summary()
...
np.savez_compressed('./embeddings/EBH_CD_mit-ptb_gallery.npz',Train_Embeddings)
np.savez_compressed('./embeddings/EBH_CD_mit-ptb_probe.npz',Test_Embeddings)
