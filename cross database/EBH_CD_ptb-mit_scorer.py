...
####### Loading Dataset
Train_Embeddings = np.load('./embeddings/EBH_CD_ptb-mit_gallery.npz',allow_pickle=True)['arr_0']
Test_Embeddings = np.load('./embeddings/EBH_CD_ptb-mit_probe.npz',allow_pickle=True)['arr_0']
y_train = np.load('./Data/y_MIT_Gallery.npz',allow_pickle=True)['arr_0']
y_dev = np.load('./Data/y_MIT_Probe.npz',allow_pickle=True)['arr_0']

###### Score File Generation
##### Defining Essentials
match_text_genuine = open("./score files/EBH_CD_ptb-mit_Genuine.txt",'w') # Matching Text File Creation for Genuine
match_text_imposter = open("./score files/EBH_CD_ptb-mit_Imposter.txt",'w') # Matching Text File Creation for Imposter 
num_probe_samples = 47 # Number of Subjects to be considered in Probe            
num_gallery_samples = 47 # Number of Subjects to be considered in Gallery
